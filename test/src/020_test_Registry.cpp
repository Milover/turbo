...
int main(int argc, char* argv[])
{
	...
	[[maybe_unused]] auto tmp_1 {master.get<input::Density>()};			// stored, return value discarded
	[[maybe_unused]] auto tmp_2 {master.get<input::NumberOfBlades>()};	// stored, return value discarded

	// try some variables with default values
	[[maybe_unused]] auto tmp_3 {master.get<input::IncidenceAngle>()};	// stored, return value discarded
	...
	[[maybe_unused]] auto tmp_4 {slave.get<input::BladeVelocity>()};	// stored, return value discarded
	[[maybe_unused]] auto tmp_5 {slave.get<input::Chord>()};			// stored, return value discarded

	// try some variables with default values
	[[maybe_unused]] auto tmp_6 {slave.get<input::Solidity>()};			// stored, return value discarded
